...
class Graph:
    ...
    def __init__(self, fname = None, numVertices = None, numEdges = None, weightRange = None, directed = True):
        ...
        self.weight = {}
        if fname == None:
            if any(arg == None for arg in (numVertices, weightRange)):
                numVertices, weightRange = map(int, input("numVertices, weightRange: ").split())
    ...
    def randomGraph_bis(self, numVertices, numEdges, weightRange, directed):
        """
    ...
    def randomGraph(self, numVertices, numEdges, weightRange, directed):
        ...
        for fromVertex in range(numVertices):
            self.adjacent[fromVertex] = set()
            for toVertex in range(numVertices):
